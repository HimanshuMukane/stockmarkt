...
def process_stock(symboltoken):
    ...
    # with open("data_api.txt", "w") as f:
    #     # print(data_json)
        # f.write(str(data_json))
        # it()
    # with open("data_static.txt", "w") as f:
        # print(data_json)
        # f.write(str(data_json))
        # exit()
...
def main():
    ...
    # print(f"Processing for {start_datetime}")
    while start_datetime != current_datetime:
        ...
        for symboltoken in current_stocks:
            # print(f"Processing symbol {symboltoken} at {start_datetime}")
